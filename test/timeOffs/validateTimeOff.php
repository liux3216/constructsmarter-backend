...
//-----------------------------------------------------------------
$db->exec(
    "UPDATE `timeOffs` SET `void` = \"no\", `validateReason` = ? WHERE `id` = ?;", 
...
sendEmail([
    ...
    "db" => $db, 
    "to" => $uniqueEmails, 
    "summary" => "Time Off Form Validation", 
    "body" => "&nbsp;&nbsp;&nbsp;&nbsp;$userName validated a time off form, Please see the reason below:<br>
    &nbsp;&nbsp;&nbsp;&nbsp;
